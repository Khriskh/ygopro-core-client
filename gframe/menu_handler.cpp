	...
	case irr::EET_GUI_EVENT: {
		...
		case irr::gui::EGET_BUTTON_CLICKED: {
			...
			case BUTTON_HOST_ONLINE: {
				wchar_t texto[1024];
				myswprintf(texto, L"Lista %ls,Cartas %ls,modo %ls #%ls", mainGame->cbLFlist->getSelected(), mainGame->cbRule->getSelected(), mainGame->cbMatchMode->getSelected(), mainGame->ebServerName->getText());
