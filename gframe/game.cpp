...
void Game::ShowCardInfo(int code, bool resize) {
	...
	if(cd.type & TYPE_MONSTER) {
		...
		if ((cd.type & TYPE_LINK) && (cd.level > 5)) {
			stDataInfo->setRelativePosition(rect<s32>(15, 60, 296, 324 * yScale));
			stSetName->setRelativePosition(rect<s32>(15, 98, 296 * xScale, 324 * yScale));
			...
			stDataInfo->setRelativePosition(rect<s32>(15, 60, 296, 324 * yScale));		
			stSetName->setRelativePosition(rect<s32>(15, 83, 296 * xScale, 324 * yScale));
