...
bool Game::Initialize() {
	...
	//main menu
	wchar_t strbuf[256];
	myswprintf(strbuf, L"YGOPro Link Version:%X.%X.%X", PRO_VERSION >> 12, (PRO_VERSION >> 4) & 0xff, PRO_VERSION & 0xf);
...
//	btnTestMode = env->addButton(rect<s32>(10, 135, 270, 165), wMainMenu, BUTTON_TEST_MODE, dataManager.GetSysString(1203));
	...
	env->addStaticText(L"Thanks to:", rect<s32>(10, 220, 270, 240), false, false, wMainMenu);
	env->addStaticText(L"Fluorohydride", rect<s32>(10, 240, 270, 260), false, false, wMainMenu);
	env->addStaticText(L"Mercury233", rect<s32>(10, 260, 270, 280), false, false, wMainMenu);

	env->addStaticText(L"SUBSCRIBE TO:", rect<s32>(10, 300, 270, 320), false, false, wMainMenu);
	env->addStaticText(L"www.youtube.com/Christian06", rect<s32>(10, 320, 270, 340), false, false, wMainMenu);

	env->addStaticText(L"", rect<s32>(10, 340, 270, 360), false, false, wMainMenu);
