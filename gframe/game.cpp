...
//	btnTestMode = env->addButton(rect<s32>(10, 135, 270, 165), wMainMenu, BUTTON_TEST_MODE, dataManager.GetSysString(1203));
	...
	btnReplayStart->setImage(imageManager.btnr1);
	...
	btnReplayPause->setImage(imageManager.btnr2);
	...
	btnReplayStep->setImage(imageManager.btnr3);
	...
	btnReplayUndo->setImage(imageManager.btnr4);
	...
	btnReplaySwap->setImage(imageManager.btnr5);
	...
	btnReplayExit->setImage(imageManager.btnr6);
