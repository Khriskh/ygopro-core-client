...
bool Game::Initialize() {
	...
	//main menu
	wchar_t strbuf[256];
	myswprintf(strbuf, L"YGOPro Link Test", PRO_VERSION >> 12, (PRO_VERSION >> 4) & 0xff, PRO_VERSION & 0xf);
	wMainMenu = env->addWindow(rect<s32>(370, 200, 700, 540), false, strbuf);
...
//	btnTestMode = env->addButton(rect<s32>(10, 135, 270, 165), wMainMenu, BUTTON_TEST_MODE, dataManager.GetSysString(1203));
	...
	env->addStaticText(L"", rect<s32>(10, 220, 270, 240), false, false, wMainMenu);
	env->addStaticText(L"Thanks to: Fluorohydride", rect<s32>(10, 240, 270, 260), false, false, wMainMenu);
	env->addStaticText(L"", rect<s32>(10, 260, 270, 280), false, false, wMainMenu);

	env->addStaticText(L"HELP US SUBSCRIBE TO:", rect<s32>(10, 300, 270, 320), false, false, wMainMenu);
	env->addStaticText(L"www.youtube.com/Christian06", rect<s32>(10, 320, 270, 340), false, false, wMainMenu);

	env->addStaticText(L"www.facebook.com/ygoproes", rect<s32>(10, 340, 270, 360), false, false, wMainMenu);
	env->addStaticText(L"www.ygoproes.wordpress.com www.facebook.com/groups/ygoprospanish", rect<s32>(10, 360, 270, 380), false, false, wMainMenu);
...
#endif
		if(cur_time >= 1000) {
			myswprintf(cap, L"YGOPRO LINK", fps);
