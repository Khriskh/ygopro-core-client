...
void Game::DrawMisc() {
	...
	//avatar
	driver->draw2DImage(imageManager.tAvatar1, Resize(330, 60, 75, 75), recti(0, 0, 75, 75), 0, 0, true);
	driver->draw2DImage(imageManager.tAvatar2, Resize(691, 60, 75, 75), recti(0, 0, 75, 75), 0, 0, true);
