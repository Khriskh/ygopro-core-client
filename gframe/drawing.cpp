...
void Game::DrawMisc() {
	...
	//avatar image
	driver->draw2DImage(imageManager.tAvatar[0], Resize(335, 16, 400, 80), recti(0, 0, 128, 128), 0, 0, true);
	driver->draw2DImage(imageManager.tAvatar[1], Resize(920, 16, 985, 80), recti(0, 0, 128, 128), 0, 0, true);
	if((dInfo.turn % 2 && dInfo.isFirst) || (!(dInfo.turn % 2) && !dInfo.isFirst)) {
		...
		driver->draw2DImage(imageManager.tLPBarFrame, Resize(695, 8, 993, 88), recti(0, 80, 298, 160), 0, 0, true);
	} else {
		driver->draw2DImage(imageManager.tLPBarFrame, Resize(327, 8, 625, 88), recti(0, 0, 298, 80), 0, 0, true);
		driver->draw2DImage(imageManager.tLPBarFrame, Resize(695, 8, 993, 88), recti(0, 80, 298, 160), 0, 0, true);
	}
	...
	if(!dInfo.start_lp[0])
		...
		driver->draw2DImage(imageManager.tLPBar, Resize(411, 14, 623, 41), recti(0, 0, 212, 27), 0, 0, true);
	else driver->draw2DImage(imageManager.tLPBar, Resize(411, 14, 411 + 212 * dInfo.lp[0] / dInfo.start_lp[0], 41), recti(0, 0, 212 * dInfo.lp[0] / dInfo.start_lp[0], 27), 0, 0, true);
	...
	if(!dInfo.start_lp[1])
		...
		driver->draw2DImage(imageManager.tLPBar, Resize(697, 14, 909, 41), recti(0, 27, 212, 54), 0, 0, true);
	else driver->draw2DImage(imageManager.tLPBar, Resize(909 - 212 * dInfo.lp[1] / dInfo.start_lp[1], 14, 909, 41), recti(212 - (212 * dInfo.lp[1] / dInfo.start_lp[1]), 27, 212, 54), 0, 0, true);
...
void Game::DrawDeckBd() {
	...
	0% — 00
	*/
	driver->draw2DRectangle(Resize(11, 314, 296, 314), 0x99FFFFFF, 0x99FFFFFF, 0x99FFFFFF, 0x99FFFFFF);
	driver->draw2DRectangleOutline(Resize(11, 281, 296, 314));
	driver->draw2DRectangle(Resize(11, 314, 296, 625), 0x99000000, 0x99000000, 0x99000000, 0x99000000);
	driver->draw2DRectangleOutline(Resize(11, 314, 296, 625));
	...
	driver->draw2DRectangle(Resize(638, 137, 797, 157), 0x99000000, 0x99000000, 0x99000000, 0x99000000);
	...
	driver->draw2DRectangle(Resize(310, 160, 797, 436), 0x99000000, 0x99000000, 0x99000000, 0x99000000);
	...
	//extra deck
	driver->draw2DRectangle(Resize(310, 440, 410, 460), 0x99000000, 0x99000000, 0x99000000, 0x99000000);
	...
	//type count 2DRectangle
	driver->draw2DRectangle(Resize(582, 440, 797, 460), 0x99000000, 0x99000000, 0x99000000, 0x99000000);
	...
	driver->draw2DRectangle(Resize(310, 463, 797, 533), 0x99000000, 0x99000000, 0x99000000, 0x99000000);
	...
	//side deck
	driver->draw2DRectangle(Resize(310, 537, 410, 557), 0x99000000, 0x99000000, 0x99000000, 0x99000000);
	...
	//type count 2DRectangle
	driver->draw2DRectangle(Resize(638, 537, 797, 557), 0x99000000, 0x99000000, 0x99000000, 0x99000000);
	...
	driver->draw2DRectangle(Resize(310, 560, 797, 630), 0x99000000, 0x99000000, 0x99000000, 0x99000000);
	...
	//search result
	driver->draw2DRectangle(Resize(805, 137, 926, 157), 0x99000000, 0x99000000, 0x99000000, 0x99000000); // 0xAARRGGBB with Alpha+RGB color (Alpha=0xFF:opaque,0x00:transparent).	
	...
	driver->draw2DRectangle(Resize(805, 160, 1020, 630), 0x99000000, 0x99000000, 0x99000000, 0x99000000);
