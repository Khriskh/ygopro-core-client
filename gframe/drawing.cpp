...
void Game::DrawMisc() {
	...
	//avatar
	driver->draw2DImage(imageManager.tAvatar1, Resize(323, 33, 395, 90), recti(0, 0, 75, 75), 0, 0, true);
	driver->draw2DImage(imageManager.tAvatar2, Resize(924, 33, 996, 90), recti(0, 0, 75, 75), 0, 0, true);
