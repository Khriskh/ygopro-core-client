...
void Game::DrawMisc() {
	...
	if((dInfo.turn % 2 && dInfo.isFirst) || (!(dInfo.turn % 2) && !dInfo.isFirst)) {
		...
		driver->draw2DImage(imageManager.tAvatar2, Resize(710, 5, 990, 150), recti(0, 0, 600, 100), 0, 0, true);
	} else {
		...
		driver->draw2DImage(imageManager.tAvatar1, Resize(710, 5, 990, 150), recti(0, 0, 600, 100), 0, 0, true);
	}
